1. Q Learning is a program that finds the best action possible based on the current state. The Q stands for quality, or how useful a current action is based on desired results.
